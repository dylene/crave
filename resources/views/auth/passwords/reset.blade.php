...
<div class="container container-xxl">
    <div class="authentication-wrapper authentication-basic container-p-y">
      <div class="d-flex justify-content-center authentication-inner">
        <!-- Register -->
        <div class="card">
          <div class="card-body">
            <!-- Logo -->
            ...
            <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-3 form-password_confirmation-toggle">
                    <div class="input-group input-group-merge">
                        ...
                        class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" required autocomplete="current-password_confirmation">
                ...
                <div class="mb-3">
                    <button class="btn btn-danger d-grid w-100" type="submit">{{ __('Reset Password') }}</button>
                </div>
            </form>
          </div>
        </div>

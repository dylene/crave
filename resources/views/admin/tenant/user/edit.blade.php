        ...
        <div class="row">
            <div class="col-md-12 order-1">
                <div class="breadscrumbs">
                    <h4 class="text-capitalize">{{ $tenant->name }} / Users / Update / {{ $user->name }}</h4>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.users.update', ['tenant' => $tenant->id, 'user' => $user->id]) }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="name" value="{{ $user->name }}" class="form-control  @error('name') is-invalid @enderror" id="basic-icon-default-name" placeholder="Enter name" aria-label="Enter name" aria-describedby="basic-icon-default-name">
                                    @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="email" name="email" value="{{ $user->email }}" id="basic-icon-default-email" class="form-control @error('email') is-invalid @enderror" placeholder="Enter email" aria-label="Enter email" aria-describedby="basic-icon-default-email">
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </span>

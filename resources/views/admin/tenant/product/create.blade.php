        ...
        <div class="row">
            <div class="col-md-12 order-1">
                <div class="breadscrumbs">
                    <h4 class="text-capitalize">{{ $tenant->name }} / Products / Create</h4>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.products.store', $tenant->id) }}" enctype="multipart/form-data" method="post">
                        
                            @csrf
                            <input type="hidden" name="max_products" value="{{$tenant->subscription->max_products}}">
                            <input type="hidden" name="uploaded_products" value="{{sizeof($products)}}">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" name="price" step="any" id="basic-icon-default-price" class="form-control @error('price') is-invalid @enderror" placeholder="Enter price" aria-label="Enter price" aria-describedby="basic-icon-default-price">
                                    @error('price')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </span>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-quantity" class="input-group-text"><i class='bx bxs-bar-chart-alt-2'></i></span>
                                    <input type="number" name="quantity" class="form-control  @error('quantity') is-invalid @enderror" id="basic-icon-default-quantity" placeholder="Enter quantity" aria-label="Enter quantity" aria-describedby="basic-icon-default-quantity">
                                    @error('quantity')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </span>
                            ...
                            <a href="{{ route('admin.tenants.show', $tenant->id) }}" class="btn btn-dark">Cancel</a>
